...
Руководитель отдела оценки и Руководитель отдела продаж компании FRESH это лидеры команды профессионалов!
...
Но даже сильному лидеру и профессионалу, порой нужна поддержка! Поэтому мы создали этого FRESHBOTA, который поможет тебе в повседневной работе с командой, целями и процессами! 😊
...
"""
    ...
    delayed_text = "Выбери раздел который тебя интересует и FRESHBOT тебе поможет!"
