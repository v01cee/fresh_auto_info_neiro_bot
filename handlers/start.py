...
"""
        ...
        case "warehouse_buyout":
            # Создаем кнопку "Назад" к меню "Контроль качества предпродажной подготовки"
            pre_sale_back_buttons = {
                "<- Назад": "back_to_pre_sale"
            }
            keyboard = await keyboard_templates.keyboard_ops.create_keyboard(pre_sale_back_buttons, interval=1)
            await callback.message.edit_text("В разработке", reply_markup=keyboard)
...
"""
        ...
        case "competencies_corporate":
            corporate_text = """
• Уважение к сотрудникам и клиентам
- это твоя способность понимать и удовлетворять потребности клиента

• Нацеленность на результат
-способность достигать цели, демонстрировать высокий уровень качества исполнения работы

• Постоянное обучение и развитие
это готовность совершенствовать себя и свою работу

• Командность
- способность успешно работать с другими сотрудниками компании, добиваться скоординированных действий для реализации целей компании

• Ответственность
- способность адекватно отвечать за то, что ему поручено либо за то, что он взял на себя сам
...
• Знание элементов финального ценообразования (вложения, состояние, рынок, прогнозируемая рентабельность, количество ДТП, история)
...
• Умение формировать отчетность ОО, вести табель учета рабочего времени.
...
• Умение создавать Индивидуальные планы развития (ИПР) для СЭО и экспертов по оценке
• Умение оценивать компетенции кандидатов на должность СЗО
...
"""
        ...
        case "back_to_functionality":
            # Возвращаемся к меню "Функционал РОО"
            functionality_text = """
Функционал РОО
...
"""
        ...
        case "back_to_warehouse_menu":
            # Возвращаемся к меню "Работа со складом"
            warehouse_text = """
Работа со складом
...
"""
        ...
        case "back_to_pre_sale":
            # Возвращаемся к меню "Контроль качества предпродажной подготовки"
            pre_sale_text = """
Контроль качества сделанной предпродажной подготовки
